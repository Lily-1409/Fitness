...
/* harmony import */ var _modules_play_video__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/play-video */ "./js/modules/play-video.js");
/* harmony import */ var _modules_play_video__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_play_video__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _modules_swiper_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/swiper-slider */ "./js/modules/swiper-slider.js");
/* harmony import */ var _modules_phone_input__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/phone-input */ "./js/modules/phone-input.js");
/* harmony import */ var _modules_phone_input__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_phone_input__WEBPACK_IMPORTED_MODULE_6__);
...
function setupVideo() {
  var video = document.querySelector('.gym-video');
  var link = video.querySelector('.gym-video__link');
  var button = video.querySelector('.gym-button');
...
/***/ "./js/modules/swiper-slider.js":
/*!*************************************!*\
  !*** ./js/modules/swiper-slider.js ***!
  \*************************************/
/*! exports provided: swiperTrainers, swiperReviews */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "swiperTrainers", function() { return swiperTrainers; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "swiperReviews", function() { return swiperReviews; });
var swiperTrainers = new window.Swiper('.swiper-trainers', {
  watchoverflow: true,
  slidesPerColumn: 1,
  breakpoints: {
    320: {
...
var swiperReviews = new window.Swiper('.swiper-reviews', {
  watchoverflow: true,
  slidesPerColumn: 1,
  slidesPerView: 1,
  // Optional parameters
  ...
  var currentSlide = slides[realIndex];
...
var _loop = function _loop(i) {
  var openTab = function openTab(event) {
    ...
    var tabContentChildren = event.target.parentElement.nextElementSibling.children;
    for (var c = 0; c < tabContentChildren.length; c++) {
      tabContentChildren[c].classList.remove('content--active');
    }
    // добавляем активный класс
    contents[i].classList.add('content--active');
    var contentsItem = contents[i].querySelectorAll('.content__item');
    var _loop3 = function _loop3(j) {
      contentsItem[j].addEventListener('focus', function () {
        contentsItem[j].classList.remove('focus-visible');
        contentsItem[j].removeAttribute('data-focus-visible-added');
      });
    };
    for (var j = 0; j < contentsItem.length; j++) {
      _loop3(j);
    }
  };
...
var _loop2 = function _loop2(_i) {
  tabs[_i].addEventListener('keydown', function (event) {
    if (event.keyCode === 13 || event.keyCode === 32) {
      (function () {
        // сначала нам нужно удалить активный класс именно с вкладок
        var tabsChildren = event.target.parentElement.children;
        ...
        // добавляем активный класс
        tabs[_i].classList.add('tab--active');
        // теперь нужно удалить активный класс с блоков содержимого вкладок
        var tabContentChildren = event.target.parentElement.nextElementSibling.children;
        for (var c = 0; c < tabContentChildren.length; c++) {
          tabContentChildren[c].classList.remove('content--active');
        ...
        // добавляем активный класс
        contents[_i].classList.add('content--active');
        var contentsItem = contents[_i].querySelectorAll('.content__item');
